...
See the [release process](https://github.com/ecrypty/florijncoincore/blob/master/doc/release-process.md)
in the Dash repository for how to
deterministically build binaries and then pgp-sign them.

[Instructions for setting up a virtual machine](https://github.com/ecrypty/florijncoincore/blob/master/doc/gitian-building.md) in which you can
gitian build as well as [public keys of developers and active contributors](https://github.com/ecrypty/florijncoincore/tree/master/contrib/gitian-keys) can also be found there.
...
or something like
```
[GNUPG:] FILE_START 1 0.9.9.9-win-signed/some_food/florijncoin-win-signer-build.assert.sig
